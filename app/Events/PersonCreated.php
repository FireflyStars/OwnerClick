...
class PersonCreated
{
    ...
    {
        $this->data = $person;
//        Auth::user()->notify(new PersonCreatedNotification($this->person));
    ...
    static function get($data){
        ...
        $eventMessage->title = __('events.person_created_title',['name'=>@$data['name']]);
        $eventMessage->message =  __('events.person_created_message',['name'=>@$data['name']]);;
