...
class PropertyUpdated
{
    ...
    {
        $this->data = $property;
//        Auth::user()->notify(new PropertyUpdatedNotification($this->property));
    ...
    static function get($data){
        ...
        $eventMessage->title = __('events.property_updated_title',['propertyName'=>@$data['propertyName'],'unitName'=>@$data['unitName']]);
        $eventMessage->message = __('events.property_updated_message',['address'=>$data['address'],'type_id'=>Property::getTypes()[$data['type_id']]['name']]);
