            ...
            @if(!isset($item->property_id))
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <span>{{__('dashboard.select_the_category_of_the_property')}}</span>
                    </div>
                    <div class="col-sm-8">
                        <div class="row">
                            <div class="col-sm-6">
            ...
            @if($formAction == 'units.store' OR $formAction == 'units.update')
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <span>{{__('dashboard.you_can_add_your_independent_section')}}</span>
                    </div>
                    <div class="col-sm-8">
                        <div class="row">
                            <div class="col-sm-12">
                        ...
                        <div id="unit-data" class="row unitGroupForm">
                            <div class="col-sm-12">
                                <h6><span class="bagimsiz-bolum">1</span>.{{__('dashboard.unit')}}</h6>
                            </div>
                            <div class="col-4 col-sm-4">
                                <label class="col-form-label">{{__('dashboard.type')}}</label>
                                {!! \App\Models\Form::select('type_id[]',\App\Models\Unit::getTypes(),$item,$errors) !!}
                            </div>
...
<script>
    function modalInit() {
        ...
        var partnerGroupForm = $(document).find('.unitGroupForm:last').clone();
        ...
        $('.element-clone').on('click', function () {
            ...
            $(document).find('.unitGroupForm:last').after(partnerGroupForm[0].outerHTML)
            // $(this).parent().parent().before(elem);
            $('#propertiesModal .selectpicker').selectpicker('refresh')
            renderUnitNumber();
